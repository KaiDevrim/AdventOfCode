...
public class Solution
{
    ...
    private readonly string _input = @"sszojmmrrkwuftyv
isaljhemltsdzlum
fujcyucsrxgatisb
qiqqlmcgnhzparyg
oijbmduquhfactbc
...
";
    ...
    public void Solution1()
    {
        ...
        {
            string line;
            while ((line = reader.ReadLine()) != null) Solution1(line);
            Console.WriteLine("\n" + _day + "\n" + _total1 + "\n" + _total2);
        }
    }
    ...
    {
        // aeiou
        // must contain double letters (dd,cc,ff)
    ...
    private bool ContainsVowels(string input)
    {
        ...
        if (amountOfVowels >= 3)
        {
            Console.WriteLine("true for vowels");
            return true;
        }

        Console.WriteLine("false for vowels");
        return false;
    }

    private bool ContainsDoubles(string input)
    {
        for (int i = 1; i < input.Length; i++)
            if (input[i] == input[i - 1])
            {
                Console.WriteLine("true for doubles");
                return true;
            }

        Console.WriteLine("false for doubles");
        return false;
    }

    private bool ContainsBadPairs(string input)
    {
        foreach (string pairs in _badpairs)
            if (input.Contains(pairs))
                return true;
    ...
    private bool ContainsSpacedPairs(string input)
    {
        for (int i = 2; i < input.Length; i++)
            ...
            {
                Console.WriteLine("True for Double Pairs");
                return true;
            }
